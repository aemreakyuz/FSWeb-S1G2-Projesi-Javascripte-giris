...
let kmValue = 100;
let milValue = milDonusturucu(kmValue);
console.log(kmValue + " km, yaklaşik olarak " +  milValue + " mil." );
...
let cmValue = 100;
let feetValue = feetDonusturucu(cmValue);
console.log(cmValue + " cm, yaklaşik olarak " + feetValue + " feet.");
...
console.log(sesliHarfSayaci("iLoveJavaScript"));
